...
// [4] redux-persist 설정, // const presistConfig={ key:'key이름', storage vs storageSession }
import storage from "redux-persist/lib/storage"; // 로컬스토리지 사용
import storageSessin from "redux-persist/lib/storage/session"; // session 사용
