...
export default function Component14(props){
    ...
    return (<> 
        ...
        <p> Box는 div 와 같은 유형, css 적용하는 방법 : 1. CSS파일 2. CSS객체 </p>
...
/*
        1. 리액트에서 CSS 적용하는 방법
            1안) CSS파일 생성한다. --> CSS 파일을 적용할 컴포넌트에서 import 'css파일경로'
            2안) CSS객체 -->JSX 컴포넌트에서 객체유형으로 CSS작성한다. <컴포넌트명 style={{ CSS카멜표기법 }}
                주의할점 : - 하이픈 대신에 카멜표기법 사용한다.
                { font-sixe : 10px } ---> { font-sixe : "10" }
*/
