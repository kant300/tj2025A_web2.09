...
// 1. 라우터 (터미널) 설치 : npm i react-router-dom , *리액트 종료된 상태에서 진행, 설치후 리액트 실행
...
export default function Component12 (props){
    return(<>
        ...
        <ul>
            <a href="/"> 메인페이지(home) </a>
            { /* 진짜URL 이 아닌 가상의 URL로 이동할때는 <a> 마크업대신 <Link>사용 */}
            <Link to="/" > 메인페이지(home/react라우터방식) </Link>
            <Link to="/about"> 소개페이지 </Link>
            <Link to="/mypage"> 마이페이지 </Link>
            <Link to="/mypage?name=유재석&age=40"> 마이페이지2 </Link>
