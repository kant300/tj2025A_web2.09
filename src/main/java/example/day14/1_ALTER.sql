...
# [1]
DROP TABLE IF EXISTS  employee;	-- 테이블생성
...
ALTER TABLE emplyee DROP PRIMARY KEY;
# ALTER TABLE 테이블명 DROP FOREIGN KEY 삭제할FK명;
